...
<head>
  ...
  <meta name="title" content="{{ $metaTitle ?? config('settings.brand_name', 'Panel') }}">
  <meta name="description" content="{{ $metaDescription ?? 'Pratham Legal is a trusted law firm offering expert legal services, insightful articles, and professional advice across corporate, civil, and criminal law matters.' }}">
