...
<style>
    .case-wrapper {
        background: {{route('case.study.view')}}fff;
        border: 1px solid {{route('case.study.view')}}efefef;
        border-radius: 14px;
    ...
    .case-wrapper:hover {
        ...
        border-color: {{route('case.study.view')}}ffd6d6;
    }
    .case-img {
        width: 100%;
        height: 180px;
        background: {{route('case.study.view')}}fff7f7;
        display: flex;
        align-items: center;
    ...
    .case-tag {
        ...
        background: {{route('case.study.view')}}fff2f2;
        color: {{route('case.study.view')}}ff1f1f;
        font-size: 13px;
        font-weight: 600;
        border-radius: 8px;
        padding: 4px 14px;
    ...
    .case-title {
        font-size: 20px;
        font-weight: 700;
        color: {{route('case.study.view')}}111;
        margin-bottom: 12px;
    }
    .case-text {
    ...
    .case-text p {
        color: {{route('case.study.view')}}555;
        margin-bottom: 18px;
        font-size: 16px;
        line-height: 1.6;
    }
    .theme_btn3 {
        ...
        font-size: 15px;
        font-weight: 600;
        background: {{route('case.study.view')}}ff1f1f;
        color: {{route('case.study.view')}}fff;
        transition: background .2s;
        box-shadow: 0 2px 8px rgba(255,31,31,0.08);
    }
    .theme_btn3:hover {
        background: {{route('case.study.view')}}d90000;
        color: {{route('case.study.view')}}fff;
    }
    .case-icon {
        position: absolute;
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-40">
                    <div class="case-wrapper">
                        <div class="case-img">
                            <a href="{{route('case.study.view')}}"><img class="img-fluid" src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=600&q=80" alt="Business Expansion"></a>
                            <span class="case-icon"><img src="/assets/img/icon/icon3.svg" alt="Business Setup"></span>
                        </div>
                        <div class="case-text">
                            <span class="case-tag">Business Setup</span>
                            <h3 class="case-title"><a href="{{route('case.study.view')}}">Business Expansion in India</a></h3>
                            ...
                            <a href="{{route('case.study.view')}}" class="theme_btn theme_btn3">Read More <i class="far fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <!-- Case Study 2 -->
                <div class="col-lg-4 col-md-6 mb-40">
                    <div class="case-wrapper">
                        <div class="case-img">
                            <a href="{{route('case.study.view')}}"><img class="img-fluid" src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=600&q=80" alt="Trademark Registration"></a>
                            <span class="case-icon"><img src="/assets/img/icon/icon9.svg" alt="IPR"></span>
                        </div>
                        <div class="case-text">
                            <span class="case-tag">IPR Services</span>
                            <h3 class="case-title"><a href="{{route('case.study.view')}}">Trademark Registration Success</a></h3>
                ...
                <div class="col-lg-4 col-md-6 mb-40">
                    <div class="case-wrapper">
                        <div class="case-img">
                            <a href="{{route('case.study.view')}}"><img class="img-fluid" src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=600&q=80" alt="Foreign National Entry"></a>
                        ...
                        <div class="case-text">
                            ...
                            <h3 class="case-title"><a href="{{route('case.study.view')}}">Foreign National Entry</a></h3>
                ...
                <div class="col-lg-4 col-md-6 mb-40">
                    <div class="case-wrapper">
                        <div class="case-img">
                            <a href="{{route('case.study.view')}}"><img class="img-fluid" src="https://images.unsplash.com/photo-1521737852567-6949f3f9f2b5?auto=format&fit=crop&w=600&q=80" alt="Corporate Compliance"></a>
                            <span class="case-icon"><img src="/assets/img/icon/icon4.svg" alt="Compliance"></span>
                        </div>
                        <div class="case-text">
                            <span class="case-tag">Compliance</span>
                            <h3 class="case-title"><a href="{{route('case.study.view')}}">Corporate Compliance Management</a></h3>
                ...
                <div class="col-lg-4 col-md-6 mb-40">
                    <div class="case-wrapper">
                        <div class="case-img">
                            <a href="{{route('case.study.view')}}"><img class="img-fluid" src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=600&q=80" alt="Legal Documentation"></a>
                            <span class="case-icon"><img src="/assets/img/icon/icon21.svg" alt="Legal Services"></span>
                        </div>
                        <div class="case-text">
                            <span class="case-tag">Legal Services</span>
                            <h3 class="case-title"><a href="{{route('case.study.view')}}">Legal Documentation & Transactions</a></h3>
                ...
                <div class="col-lg-4 col-md-6 mb-40">
                    <div class="case-wrapper">
                        <div class="case-img">
                            <a href="{{route('case.study.view')}}"><img class="img-fluid" src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=600&q=80" alt="Regulatory Advisory"></a>
                            <span class="case-icon"><img src="/assets/img/icon/tick2.svg" alt="FEMA Advisory"></span>
                        </div>
                        <div class="case-text">
                            <span class="case-tag">FEMA Advisory</span>
                            <h3 class="case-title"><a href="{{route('case.study.view')}}">Regulatory & FEMA Advisory</a></h3>
                    ...
                    <div class="col-xl-10">
                        <div class="subscribe-wrapper">
                            <div class="section-title text-center">
                                ...
                                <a href="{{ route('contact') }}" class="theme_btn theme_btn3">Get your free quote <i class="far fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
