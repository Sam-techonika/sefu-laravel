        ...
        <section class="blog-area pt-80 pb-75 pt-md-0 pb-md-35 pt-xs-0 pb-xs-35">
            <div class="container">
                <div class="row">
                    ...
                    $slug = $trans->slug ?? '';
                    $categoryName = $trans && $trans->category ? optional($trans->category->translations->firstWhere('locale', app()->getLocale()))->name : 'General';
                    $link = url(app()->getLocale() . '/blog' . $slug);
                    @endphp
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="blogs mb-50">
                            ...
                            <div class="blogs__content">
                                ...
                                <h3 class="blog-title mb-20"><a href="{{ route('blog.view', ['locale' => app()->getLocale(), 'slug' => $slug]) }}">
                                        {{ \Illuminate\Support\Str::limit($title, 80) }}
                                    </a>
                                </h3>
                                <a class="blog-btn" href="{{ $link }}"><img src="{{ asset('assets/img/icon/icon12.svg') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
