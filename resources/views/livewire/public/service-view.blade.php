            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="get-answer text-center mt-20">
                        ...
                        <a wire:navigate href="{{ route('contact') }}" class="theme_btn faq-btn">Contact us</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-10">
                        <div class="subscribe-wrapper text-center">
                            <div class="section-title">
                                ...
                                <a wire:navigate href="{{ route('contact') }}" class="theme_btn theme_btn3">Book a call <i class="far fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
