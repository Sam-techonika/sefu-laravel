                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-4 col-md-6 mt-50 mt-md-0 mt-xs-0">
                                <div class="plan mb-30">
                                    ...
                                    <div class="plan__header text-center pb-45 mb-50">
                                        <h4 class="sub-title">Perfect for startups and small businesses filing their first trademark.</h4>
                                        </h4>
                            ...
                            <div class="col-lg-4 col-md-6 mt-50 mt-md-0 mt-xs-0">
                                <div class="plan mb-30">
                                    ...
                                    <div class="plan__header text-center pb-45 mb-50">
                                        <h4 class="sub-title">For established brands seeking full-spectrum trademark protection & monitoring.</h4>
                                        <h1 class="mb-35">₹17,999</h1>
                            ...
                            legalOpen: false
                                    ...
                                    <div class="section-content" :class="{ 'open': incorporationOpen }">
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Search & Availability Check</span>
                                            </div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Class Selection & Legal Description</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Drafting & Filing of TM-A</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Govt. Fee (One Class – Individual/MSME)</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Filing Acknowledgment & TM Symbol Use</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Application Status Tracking</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                ...
                                <div class="feature-section">
                                    ...
                                    <div class="section-content" :class="{ 'open': complianceOpen }">
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Reply to Examination Report</span>
                                            </div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Drafting of Legal Submissions</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Evidence / Affidavits Filing</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Handling of Opposition Proceedings</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                ...
                                <div class="feature-section">
                                    <div class="section-header" @click="femaOpen = !femaOpen">
                                        <div class="section-title-content">
                                            ...
                                            <span>Brand Protection & Advisory</span>
                                        </div>
                                    ...
                                    <div class="section-content" :class="{ 'open': femaOpen }">
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Trademark Assignment / Licensing Draft</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col featured"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Brand Watch & Similar Mark Monitoring</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col featured"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Legal Notice for Infringement</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col featured"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Renewal & Recordal Advisory</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col featured"><span class="icon-cross">✕</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                ...
                                <div class="feature-section">
                                    ...
                                    <div class="section-content" :class="{ 'open': corporateOpen }">
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Dedicated CS/IP Support (Call, WhatsApp, Email)</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Professional TM Advisory & Class Selection</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                        ...
                                        <div class="comparison-row">
                                            <div class="feature-col">
                                                <span class="feature-name">Continuous Monitoring until Registration</span>
                                            </div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                            <div class="plan-col featured"><span class="icon-check">✓</span></div>
                                            <div class="plan-col"><span class="icon-check">✓</span></div>
                                ...
                                @forelse($testimonials as $testimonial)
                                    <div class="feedback-item-wrapper">
                                        <div class="feedback-box fb-box-3 text-center">
                                            ...
                                            @if(!empty($translation->position) || !empty($translation->company))
                                                <h6>{{ trim(($translation->position ?? '') . ($translation->company ? ', ' . $translation->company : '')) }}</h6>
                                            @elseif(!empty($translation->address))
